...
class SafeFaceDetector extends Detector<com.google.android.gms.vision.face.Face> {
         ...
         * @param delegate
         */
        public SafeFaceDetector(FaceDetector delegate) {
            mDelegate = delegate;
        }
         ...
         */
        @Override
        public SparseArray<com.google.android.gms.vision.face.Face> detect(Frame frame) {
